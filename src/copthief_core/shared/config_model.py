...
The private-side dataclasses live in `shared/private_model` (150-line rule, M7-8) and are
...
from copthief_core.shared.private_model import EmailSettings, GuiSettings, PrivateSettings
